        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://t.me/HUB4VF/3')
                        ]]
                    )
                )
...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, [
        InlineKeyboardButton(f'⛔️  sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ ​ ⛔️', url='https://youtube.com/')
    ])
    offset = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if (AUTH_CHANNEL or REQ_CHANNEL) and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("🔰  ᴊᴏɪɴ ꜰᴏʀ ᴍᴏᴠɪᴇs​  🔰", url=f"{CHNL_LNK}")
                         ]
                        ]
                    )
                )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url=f"{CHNL_LNK}")
        ],[
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url=f"{S_GROUP}"),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url=f"{MAIN_CHANNEL}")
        ],[
        ...
        buttons = [[
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url=f'{OWN_LNK}'),
           InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url=f'{S_GROUP}')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʀᴇᴘᴏʀᴛ  ʙᴜɢꜱ  ᴀɴᴅ  ꜰᴇᴇᴅʙᴀᴄᴋ', url=f'{S_GROUP}')
        ],[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
           ...
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://telegram.me/ContactownerHUB4VF_bot')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
